...
__global__ void first_step_mixed(float4 *poss, GPU_quat *orientations, LR_double4 *possd,
		GPU_quat_double *orientationsd, const float4 *list_poss, LR_double4 *velsd,
		LR_double4 *Lsd, const float4 *forces, const float4 *torques,
